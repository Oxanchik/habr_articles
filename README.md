...
- `main.py`: Поиск по всей доступной preview-информации
- `preview_keyword-place.py`: Поиск по всей доступной preview-информации с указанием места, где найдено слово
- `full_text.py`: Поиск по всей доступной preview-информации и по тексту статей целиком
